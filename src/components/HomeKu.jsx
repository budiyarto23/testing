                    ...
                    <div className="col-lg-3 mt-4">
                        ...
                        <div className="">
                            ...
                            <ul class="list-group text-left">
                                <li class="list-group-item">Kertas Asing</li>
                                <li class="list-group-item">Kertas Indonesia</li>
                                <li class="list-group-item">Koin Asing</li>
                                <li class="list-group-item">Koin Indonesia</li>
